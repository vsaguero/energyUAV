function [percentageUsersAP, replacements] = replacementLegacy2 (time, uavs, reserve, uavLocations, users, userLocation, gcs)
    ...
    while true
        switch queue(currentEvent, eventType)
            ...
            case evSampling
                ...
                for i=1:length(remainingBattery)
                     if remainingBattery(i) <= ((batteryThresholds(i)/2))
